...
public final class RSSAggregator {
    ...
    private static void processFeed(String url, String file, SimpleWriter out) {
        ...
        if (xml.attributeValue("version").equals("2.0")) {
            ...
            SimpleWriter HTMLWriter = new SimpleWriter1L(file);
        ...
        out.println("Finished loading " + file);
    }
    ...
    public static void main(String[] args) {
        ...
        //running.
        out.println("Enter an XML input file");
        String inputName = in.nextLine();
        XMLTree xml = new XMLTree1(inputName);
        out.println("Enter an index page file");
        String outputName = in.nextLine();
        SimpleWriter fileWrite = new SimpleWriter1L(outputName);
        int childNum = getChildElement(xml, "feed");

        //The index html file
        fileWrite.println("<html>");
        fileWrite.println(" <head>");
        fileWrite.println("  <title>");
        fileWrite.println("  " + xml.attributeValue("title"));
        fileWrite.println("  </title>");
        fileWrite.println(" </head>");
        fileWrite.println(" <body>");
        fileWrite.println(" <h2>" + xml.attributeValue("title") + "</h2>");
        fileWrite.println("  <ul>");
        if (childNum > -1) {
            for (int i = childNum; i < xml.numberOfChildren(); i++) {
                ...
                fileWrite.println("   <li><a href=\"" + file + "\">" + name
                        + "</a></li>");
